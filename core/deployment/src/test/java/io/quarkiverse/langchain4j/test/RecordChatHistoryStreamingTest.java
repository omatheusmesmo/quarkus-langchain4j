...
public class RecordChatHistoryStreamingTest {
    ...
    static final QuarkusUnitTest unitTest = new QuarkusUnitTest()
            .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class)
                    .addClasses(StreamingAiService.class, StreamTestUtils.class,
                            TestStreamingChatHistoryRecorder.class));

    @Inject
    StreamingAiService streamingService;

    @Inject
    TestStreamingChatHistoryRecorder recorder;
    ...
    @ApplicationScoped
    public static class TestStreamingChatHistoryRecorder implements ChatHistoryRecorder {
