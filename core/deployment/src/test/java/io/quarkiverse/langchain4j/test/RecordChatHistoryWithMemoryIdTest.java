...
public class RecordChatHistoryWithMemoryIdTest {
    ...
    static final QuarkusUnitTest unitTest = new QuarkusUnitTest()
            .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class)
                    .addClasses(MemoryIdAiService.class, FakeChatModelSupplier.class,
                            TestMemoryIdChatHistoryRecorder.class));

    @Inject
    MemoryIdAiService service;

    @Inject
    TestMemoryIdChatHistoryRecorder recorder;
    ...
    @ApplicationScoped
    public static class TestMemoryIdChatHistoryRecorder implements ChatHistoryRecorder {
