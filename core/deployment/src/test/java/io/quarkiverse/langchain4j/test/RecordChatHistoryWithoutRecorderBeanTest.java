...
public class RecordChatHistoryWithoutRecorderBeanTest {

    @RegisterExtension
    static final QuarkusUnitTest unitTest = new QuarkusUnitTest()
            .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class)
                    .addClasses(ServiceWithNoRecorder.class, FakeChatModelSupplier.class))
    ...
    interface ServiceWithNoRecorder {
        @UserMessage("{msg}")
