...
public class RecordChatHistoryTokenStreamTest {
    ...
    static final QuarkusUnitTest unitTest = new QuarkusUnitTest()
            .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class)
                    .addClasses(TokenStreamAiService.class,
                            TestTokenStreamChatHistoryRecorder.class,
    ...
    @Inject
    TestTokenStreamChatHistoryRecorder recorder;
    ...
    @ApplicationScoped
    public static class TestTokenStreamChatHistoryRecorder implements ChatHistoryRecorder {
