...
public class MaxToolCallsPerResponseTest {
    ...
    public interface AiServiceWithZero {
        String chat(String message);
    }
    ...
    @Inject
    AiServiceWithZero aiServiceWithZero;
    ...
    @Test
    @ActivateRequestContext
    public void testDefaultLimitExceeded() {
        Tools.invocations = 0;
        responseCount = 0;
        toolCallsCounts.clear();
        toolCallsCounts.add(10);
        ...
        Assertions.assertThatThrownBy(() -> aiServiceNoLimit.chat("test"))
                .isInstanceOf(ToolCallsLimitExceededException.class)
                .hasMessageContaining("5");
