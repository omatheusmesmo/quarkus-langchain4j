...
public class RecordChatHistoryChatEventStreamingTest {
    ...
    static final QuarkusUnitTest unitTest = new QuarkusUnitTest()
            .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class)
                    .addClasses(ChatEventAiService.class, StreamTestUtils.class,
                            TestChatEventChatHistoryRecorder.class));

    @Inject
    ChatEventAiService chatEventService;

    @Inject
    TestChatEventChatHistoryRecorder recorder;
    ...
    @ApplicationScoped
    public static class TestChatEventChatHistoryRecorder implements ChatHistoryRecorder {
