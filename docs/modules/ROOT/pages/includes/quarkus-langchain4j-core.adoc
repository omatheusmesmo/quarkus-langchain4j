...
[.description]
--
Maximum number of tool calls allowed per single LLM response. When an LLM response contains more tool calls than this limit, a ToolCallsLimitExceededException is thrown. Use -1 for unlimited.
