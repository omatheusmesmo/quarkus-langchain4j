...
[.description]
--
If enabled, all AI services will record chat history via the `ChatHistoryRecorder` CDI bean, without needing the `@RecordChatHistory` annotation. If disabled, only AI services annotated with `@RecordChatHistory` will record chat history.
...
a| [[quarkus-langchain4j-core_quarkus-langchain4j-ai-service-max-tool-calls-per-response]] [.property-path]##link:#quarkus-langchain4j-core_quarkus-langchain4j-ai-service-max-tool-calls-per-response[`+++quarkus.langchain4j.ai-service.max-tool-calls-per-response+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.ai-service.max-tool-calls-per-response+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_AI_SERVICE_MAX_TOOL_CALLS_PER_RESPONSE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_AI_SERVICE_MAX_TOOL_CALLS_PER_RESPONSE+++`
endif::add-copy-button-to-env-var[]
--
|int
|`+++0+++`

a| [[quarkus-langchain4j-core_quarkus-langchain4j-ai-service-max-tool-executions]] [.property-path]##link:#quarkus-langchain4j-core_quarkus-langchain4j-ai-service-max-tool-executions[`+++quarkus.langchain4j.ai-service.max-tool-executions+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.ai-service.max-tool-executions+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Maximum number of sequential tool executions while handling a single chat request. If this number is exceeded, the chat request will fail.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_AI_SERVICE_MAX_TOOL_EXECUTIONS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_AI_SERVICE_MAX_TOOL_EXECUTIONS+++`
endif::add-copy-button-to-env-var[]
--
|int
|`+++10+++`
